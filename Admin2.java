...
public class Admin2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<title>eLibrary Admin</title>");
		...
		out.println("<li><button class='button'><a href='ViewUser' style='text-decoration:none;' target='_blank'>View User</a></button></li>");
		out.println("<li><button class='button'><a href='ViewBook' style='text-decoration:none;' target='_blank'>View Books</a></button></li>");
		out.println("<li><button class='button'><a href='ViewIssuedBook' style='text-decoration:none;' target='_blank'>View Issued Books</a></button></li>");
		out.println("<li><button class='button'><a href='index.html' style='text-decoration:none;'>Go back Home</a></button>");
		out.println("</ul>");
