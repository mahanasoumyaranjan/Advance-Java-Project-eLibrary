...
public class ViewUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<thead><tr><th>ID</th><th>NAME</th><th>EMAIL</th><th>PASSWORD</th><th>DELETE</th></tr></thead>");
		for(UserInfo u:list){
			out.println("<tbody><tr><td>"+u.getId()+"</td><td>"+u.getName()+"</td><td>"+u.getEmail()+"</td><td>"+u.getPassword()+"</td><td><a href='DeleteUser?id="+u.getId()+"'>Delete</a></td></tr></tbody>");
		}
